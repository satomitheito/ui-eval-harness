...
st.page_link("src/app/pages/1_Rater.py", label="➡️ Rater")
st.page_link("src/app/pages/2_Metrics.py", label="📊 Metrics")
st.page_link("src/app/pages/3_Admin.py", label="🛠️ Admin")
